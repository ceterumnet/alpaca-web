...
import EnhancedTelescopePanel from '@/components/devices/EnhancedTelescopePanel.vue'
...
describe('EnhancedTelescopePanel', () => {
  ...
  beforeEach(() => {
    ...
    // Mount the component
    wrapper = mount(EnhancedTelescopePanel, {
      props: {
  ...
  it('renders the panel name correctly', () => {
    const panelComponent = wrapper.findComponent({ name: 'EnhancedPanelComponent' })
