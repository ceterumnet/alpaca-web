...
import EnhancedPanelComponentMigrated from '../../../src/components/ui/EnhancedPanelComponentMigrated.vue'
import { UIMode } from '../../../src/stores/useUIPreferencesStore'
import { createPinia, setActivePinia } from 'pinia'

// Mock the UI preferences store
vi.mock('../../../src/stores/useUIPreferencesStore', async () => {
  const actual = await vi.importActual('../../../src/stores/useUIPreferencesStore')
  return {
    ...actual,
...
describe('EnhancedPanelComponentMigrated', () => {
  beforeEach(() => {
