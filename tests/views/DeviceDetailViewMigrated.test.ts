...
import DeviceDetailViewMigrated from '../../src/views/DeviceDetailViewMigrated.vue'
...
vi.mock('../../src/components/devices/TelescopePanelMigrated.vue', () => ({
  default: {
...
vi.mock('../../src/components/devices/CameraPanelMigrated.vue', () => ({
  default: {
...
vi.mock('../../src/components/ui/EnhancedPanelComponentMigrated.vue', () => ({
  default: {
