          ...
          <div class="setting-group">
            <div class="setting-row">
              ...
              <div class="toggle-switch">
                <input id="dark-mode" v-model="formState.isDarkMode" type="checkbox" />
            ...
            <div class="setting-row">
              ...
              <select id="default-ui-mode" v-model="formState.defaultUIMode">
            ...
            <div class="setting-row">
              ...
              <div class="toggle-switch">
                <input id="sidebar-visible" v-model="formState.isSidebarVisible" type="checkbox" />
                <span class="toggle-slider"></span>
              </div>
            </div>
          </div>
        ...
        <div v-if="activeTab === 'layout'" class="tab-content">
          ...
          <div class="setting-group">
            ...
            <div class="setting-actions">
              <button class="action-button danger" @click="layoutStore.resetLayout()">
        ...
        <div v-if="activeTab === 'devices'" class="tab-content">
          ...
          <div class="setting-group">
            ...
            <div class="setting-row">
              ...
              <div class="toggle-switch">
                <input id="auto-connect" v-model="formState.autoConnectDevices" type="checkbox" />
                <span class="toggle-slider"></span>
              </div>
            </div>
        ...
        <div v-if="activeTab === 'notifications'" class="tab-content">
          ...
          <div class="setting-group">
            <div class="setting-row">
              ...
              <select id="notification-position" v-model="formState.notificationPosition">
            ...
            <div class="setting-actions">
              <button class="action-button" @click="notificationStore.clearHistory()">
